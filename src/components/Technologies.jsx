...
const categoryConfig = {
  Frontend: {
    icon: Globe,
    label: "Frontend",
    topBar: "from-blue-600 to-blue-700",
  ...
  Language: {
    icon: Braces,
    label: "Language",
    topBar: "from-zinc-600 to-slate-700",
    border: "border-zinc-200/60 dark:border-zinc-800/40",
    tag: "bg-zinc-100 text-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-300",
    catText: "text-zinc-600 dark:text-zinc-400",
    filterActive: "bg-zinc-700 border-zinc-700 text-white",
    filterIdle: "border-zinc-300 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 bg-zinc-50 dark:bg-zinc-900/20",
  },
  Backend: {
    icon: Server,
    label: "Backend",
    topBar: "from-green-800 to-green-900",
    border: "border-green-800/30 dark:border-green-900/40",
    tag: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
    catText: "text-green-700 dark:text-green-400",
    filterActive: "bg-green-800 border-green-800 text-white",
    filterIdle: "border-green-800/40 dark:border-green-900 text-green-800 dark:text-green-300 bg-green-50 dark:bg-green-900/20",
  },
  Database: {
    icon: Database,
    label: "Database",
    topBar: "from-indigo-700 to-blue-800",
    border: "border-indigo-200/60 dark:border-indigo-800/40",
    tag: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
    catText: "text-indigo-700 dark:text-indigo-400",
    filterActive: "bg-indigo-700 border-indigo-700 text-white",
    filterIdle: "border-indigo-200 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-900/20",
  },
  BaaS: {
    icon: Cloud,
    label: "BaaS",
    topBar: "from-slate-600 to-slate-700",
    border: "border-slate-200/60 dark:border-slate-700/60",
    tag: "bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300",
    catText: "text-slate-600 dark:text-slate-400",
    filterActive: "bg-slate-700 border-slate-700 text-white",
    filterIdle: "border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/40",
  },
  DevOps: {
    icon: Box,
    label: "DevOps",
    topBar: "from-blue-700 to-blue-800",
    border: "border-blue-200/60 dark:border-blue-800/40",
    tag: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
    catText: "text-blue-700 dark:text-blue-400",
    filterActive: "bg-blue-700 border-blue-700 text-white",
    filterIdle: "border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/20",
  },
  Tools: {
    icon: Terminal,
    label: "Tools",
    topBar: "from-slate-700 to-slate-800",
    border: "border-slate-200/60 dark:border-slate-700/60",
    tag: "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300",
    catText: "text-slate-600 dark:text-slate-400",
    filterActive: "bg-slate-700 border-slate-700 text-white",
    filterIdle: "border-slate-300 dark:border-slate-700 text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/40",
  },
  Design: {
    icon: Palette,
    label: "Design",
    topBar: "from-indigo-700 to-slate-700",
    border: "border-indigo-200/60 dark:border-indigo-800/40",
    tag: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
    catText: "text-indigo-700 dark:text-indigo-400",
    filterActive: "bg-indigo-700 border-indigo-700 text-white",
